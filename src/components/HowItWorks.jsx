...
const HowItWorks = () => (
  <section className="py-16 bg-gray-100 text-center w-full flex flex-col gap-y-2 mx-auto">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-md:gap-7 max-sm:gap-5 w-full mx-auto">
      {steps.map((step, idx) => (
        <div key={idx} className="bg-white p-6 rounded-lg shadow-lg w-64 hover:scale-[1.05] transition-all duration-300 ease-in-out">
